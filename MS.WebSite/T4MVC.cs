...
{
    public static MS.WebSite.Controllers.HomeController Home = new MS.WebSite.Controllers.T4MVC_HomeController();
    public static MS.WebSite.Controllers.UserAreaController UserArea = new MS.WebSite.Controllers.T4MVC_UserAreaController();
...
namespace Links
{
    ...
    public static class Content {
        ...
        public static class fonts {
            ...
            public static class Nunito {
                public const string UrlPath = "~/Content/fonts/Nunito";
                public static string Url() { return T4MVCHelpers.ProcessVirtualPath(UrlPath); }
                public static string Url(string fileName) { return T4MVCHelpers.ProcessVirtualPath(UrlPath + "/" + fileName); }
                public static readonly string Nunito_Regular_ttf = Url("Nunito-Regular.ttf");
                public static readonly string OFL_txt = Url("OFL.txt");
            }
        
            [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
            public static class Pacifico {
                public const string UrlPath = "~/Content/fonts/Pacifico";
                public static string Url() { return T4MVCHelpers.ProcessVirtualPath(UrlPath); }
                public static string Url(string fileName) { return T4MVCHelpers.ProcessVirtualPath(UrlPath + "/" + fileName); }
                public static readonly string OFL_txt = Url("OFL.txt");
                public static readonly string Pacifico_ttf = Url("Pacifico.ttf");
            }
        ...
        public static readonly string style_user_area_css = T4MVCHelpers.IsProduction() && T4Extensions.FileExists(UrlPath + "/style_user-area.min.css") ? Url("style_user-area.min.css") : Url("style_user-area.css");
    }
    ...
    public static partial class Bundles
    {
        ...
        public static partial class Content 
        {
            ...
            {
                public static partial class Nunito 
                {
                    public static class Assets
                    {
                    }
                }
                public static partial class Pacifico 
                {
                    public static class Assets
                    {
                    }
            ...
            public static class Assets
            {
                ...
                public const string jquery_ui_min_css = "~/Content/jquery-ui.min.css";
                public const string jquery_timepicker_min_css = "~/Content/jquery.timepicker.min.css";
                public const string magnific_popup_css = "~/Content/magnific-popup.css";
                public const string PagedList_css = "~/Content/PagedList.css";
                public const string style_css = "~/Content/style.css";
                public const string style_user_area_css = "~/Content/style_user-area.css";
            }
        }
    }
}
